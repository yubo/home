...
vim.keymap.set("n", "<f1>",       function() dapgo.debug_test() end)
...
vim.keymap.set('n', '<f9>',       function() dap.up() end)
vim.keymap.set('n', '<s-f9>',     function() dap.down() end)
vim.keymap.set('n', '<s-f5>',     function() dap.terminate() end)
vim.keymap.set('n', '<cs-f5>',    function() dap.restart() end)
